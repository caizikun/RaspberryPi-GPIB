...
namespace InstrumentControl
{
    public class Connection
    {
        ...
        public void InitializeSSH()
        {
            ...
            // Initializing GPIB Sequence, this is for propper Prologix Operation
            ...
            // Initialize Recording, this just empties the output file. 
            SshCommand cmd5 = client.CreateCommand(string.Format("truncate -s 0 >{0}", out_file)); cmd5.Execute();

            // Start the SSH connection using Plink
    ...
    public class Test
    {
        public static void Main(string[] args)
        {
            ...
            string frequency = an.get_freq();
            Console.WriteLine(frequency);

            string power = an.get_power();
